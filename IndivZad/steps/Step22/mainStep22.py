...
class CityObject:
    def __init__(self, name=None, objType=None, adress=None, capacity=0, owner=None, openingDate=None):
        self.id=uuid.uuid4()
        self.name = name
...
class Event:
    ...
    def __str__(self):
        return f"Event(eventDate={self.eventDate}, eventName={self.eventName}, eventType={self.eventType}, visitors={self.visitors})"
